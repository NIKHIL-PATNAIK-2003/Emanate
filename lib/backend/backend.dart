...
import 'schema/investor_sign_u_p_record.dart';
import 'dart:async';
...
export 'schema/investor_sign_u_p_record.dart';
...
/// Functions to query InvestorSignUPRecords (as a Stream and as a Future).
Future<int> queryInvestorSignUPRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      InvestorSignUPRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<InvestorSignUPRecord>> queryInvestorSignUPRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      InvestorSignUPRecord.collection,
      InvestorSignUPRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<InvestorSignUPRecord>> queryInvestorSignUPRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
Future<FFFirestorePage<InvestorSignUPRecord>> queryInvestorSignUPRecordPage({
  Query Function(Query)? queryBuilder,
  DocumentSnapshot? nextPageMarker,
  required int pageSize,
  required bool isStream,
  required PagingController<DocumentSnapshot?, InvestorSignUPRecord> controller,
  List<StreamSubscription?>? streamSubscriptions,
}) =>
    queryCollectionPage(
      InvestorSignUPRecord.collection,
      ...
      if (isStream) {
        final streamSubscription =
            (page.dataStream)?.listen((List<InvestorSignUPRecord> data) {
          for (var item in data) {
            final itemIndexes = controller.itemList!
                .asMap()
                .map((k, v) => MapEntry(v.reference.id, k));
